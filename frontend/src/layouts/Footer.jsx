      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Building a community-driven sharing economy. Share resources, help others, make an impact.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <FooterLink to="/home">Browse Resources</FooterLink>
              <FooterLink to="/create">Share Resource</FooterLink>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            &copy; {currentYear} ShareSphere. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
